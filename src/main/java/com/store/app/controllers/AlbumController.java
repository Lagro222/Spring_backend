...
public class AlbumController {
  ...
  public Album update_Album(
      ...
      @AuthenticationPrincipal User current_user
        ...
        return   album_service.update(id,new_album,current_user);
  }

  @DeleteMapping("/delete/{id}")
  public void delete_Album(@PathVariable Long id,@AuthenticationPrincipal User current_user){
    album_service.delete(id,current_user);
  }
